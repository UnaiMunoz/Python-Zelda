...
def interactuar_santuario4(map, character_position):
    global lives_character  # Declarar vida_personaje como global

    santuario_position = check_nearby_element(map, character_position, 'S4?')
    if santuario_position:
        # Incrementar la vida
        lives_character += 1
        # Actualizar el mapa
        map[santuario_position[0]][santuario_position[1]] = 'S4 '
        # Mensaje
